    ...
    <div className="min-h-screen bg-black py-20 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold text-white">Hashtag Generator</h1>
              ...
              <CardContent>
                <div className="grid gap-3 sm:grid-cols-2">
                  {hashtags.map((hashtag, index) => (
                    <div
                      key={index}
                      className="group p-3 rounded-lg border border-gray-700 hover:border-purple-500 hover:bg-gray-700/50 cursor-pointer transition-all"
                        ...
                        <div className="flex-1 space-y-2">
                          ...
                          <div className="flex items-center gap-3 text-sm text-gray-400">
                            ...
                            {hashtag.competition && (
                              <Badge
                                variant="outline"
                                className={`border-gray-600 ${hashtag.competition === 'low' ? 'text-green-400' : hashtag.competition === 'medium' ? 'text-yellow-400' : 'text-red-400'}`}
                              >
                          ...
                          {hashtag.trending && (
                            <Badge className="gap-1 w-fit bg-purple-500/20 text-purple-400 border-purple-500/30">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {hashtags.slice(0, 5).map((h, i) => (
                        <Badge key={i} className="bg-gray-700 text-gray-300">#{h.tag}</Badge>
                      ))}
                    </div>
                  </div>
