        ...
        <header className="bg-slate-900/95 backdrop-blur border-b border-slate-800 px-6 py-4 sticky top-0 z-40">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold font-display text-white">Analytics Dashboard</h1>
                <p className="text-sm text-slate-400">Detailed platform analytics and insights</p>
              </div>
            </div>
