...
export default function ExploreTrendingTopicPage() {
    ...
    return (
      <div className="min-h-[600px] flex items-center justify-center">
        <div className="vb-card p-8 text-center">
          <div className="h-12 w-12 text-violet-400 animate-spin mx-auto mb-4">
  ...
  return (
    <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {topicData.hashtags.map((tag, index) => (
                  <button
                    ...
                    className="bg-white/[0.04] border border-white/[0.06] rounded-xl px-3 py-2 rounded-full text-violet-300 hover:bg-white/10 transition-colors flex items-center gap-2"
                  >
                    {tag}
        ...
        {activeSection === 'videos' && (
          <div className="space-y-4">
            ...
            {topicData.topVideos.map((video) => {
              ...
              return (
                <div key={video.id} className="vb-card p-4 flex gap-4">
                  <img 
                    src={video.thumbnail} 
                    alt={video.title}
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Button 
                      size="sm" 
                      className={`vb-btn-outline transition-all ${
                        isSaved 
          ...
          <div className="vb-card p-6">
            ...
            <div className="space-y-3">
              {topicData.keywords.map((keyword, index) => (
                <div key={index} className="bg-white/[0.04] border border-white/[0.06] rounded-xl p-4 flex items-center justify-between">
                  <div className="flex-1">
                    <p className="text-white font-medium">{keyword.word}</p>
                    <p className="text-xs text-gray-400">Volume: {keyword.volume}</p>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className={`text-sm px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.06] ${
      ...
      {/* Action Footer */}
      <div className="vb-card p-6 bg-gradient-to-r from-violet-500/10 to-cyan-500/10 animate-reveal" style={{ animationDelay: '0.4s' }}>
        <div className="flex items-center justify-between">
          <div>
